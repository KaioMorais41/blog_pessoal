...
describe('Testes dos Módulos Usuário e Auth (e2e)', () => {  // descrição do teste e2e
  ...
  it("01 - Deve criar um novo usuario", async () => { // testa se o usuario pode ser criado
    ...
    .post('/usuarios/cadastrar').send ({// acessa a pasta usuario.controller pega o controller usuarios, vai no post e pega o cadastrar.
      nome: "capivara",
      usuario: "capivara@gmail.com",
      senha: "12345678",
      foto: "-",
    }).expect(201); // espera uma resposta com o status code 201 (201 é que deu certo)
